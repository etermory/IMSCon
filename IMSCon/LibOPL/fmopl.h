...
//typedef stream_sample_t OPLSAMPLE;	//林籍 贸府

#if (OPL_SAMPLE_BITS==16)	// 林籍 力芭
typedef INT16 OPLSAMPLE;	// 林籍 力芭
#endif				// 林籍 力芭
#if (OPL_SAMPLE_BITS==8)	// 林籍 力芭
typedef INT8 OPLSAMPLE;		// 林籍 力芭
#endif				// 林籍 力芭
